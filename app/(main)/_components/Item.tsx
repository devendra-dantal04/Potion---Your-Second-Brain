...
const Item = ({ onClick, label, icon: Icon, active, documentIcon, expanded, isSearch, onExpand, level, id }: ItemProps) => {
    ...
    return (
        ...
        >
            {!!id && (
                <div
                    role="button"
                    className="h-full rounded-sm p-1 hover:bg-neutral-300 dark:bg-neutral-600 mr-1"
            ...
            {!!id && (
                <div role="button" className="ml-auto flex items-center gap-x-2" onClick={onCreate}>
                    <DropdownMenu>
                        <DropdownMenuTrigger
